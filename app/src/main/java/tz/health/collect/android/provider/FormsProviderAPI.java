...
public final class FormsProviderAPI {
    public static final String AUTHORITY = "tz.health.collect.android.provider.odk.forms";
    ...
    public static final class FormsColumns implements BaseColumns {
        ...
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.tz.health.form";
