...
import tz.health.collect.android.activities.GeoPointActivity;
import tz.health.collect.android.activities.GeoPointMapActivity;
...
public class GeoPointWidget extends QuestionWidget implements IBinaryWidget {
	...
	public GeoPointWidget(Context context, FormEntryPrompt prompt) {
		...
		mUseMapsV2 = true; //requestV2 && CompatibilityUtils.useMapsV2(context);
