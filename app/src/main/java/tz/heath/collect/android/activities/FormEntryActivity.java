...
package tz.heath.collect.android.activities;
...
import tz.heath.collect.android.exception.JavaRosaException;
import tz.heath.collect.android.listeners.AdvanceToNextListener;
import tz.heath.collect.android.listeners.FormLoaderListener;
import tz.heath.collect.android.listeners.FormSavedListener;
import tz.heath.collect.android.listeners.SavePointListener;
import tz.heath.collect.android.logic.FormController;
import tz.heath.collect.android.preferences.AdminPreferencesActivity;
import tz.heath.collect.android.preferences.PreferencesActivity;
import tz.heath.collect.android.provider.FormsProviderAPI;
import tz.heath.collect.android.provider.InstanceProviderAPI;
import tz.heath.collect.android.tasks.FormLoaderTask;
import tz.heath.collect.android.tasks.SavePointTask;
import tz.heath.collect.android.tasks.SaveResult;
import tz.heath.collect.android.tasks.SaveToDiskTask;
import tz.heath.collect.android.utilities.CompatibilityUtils;
import tz.heath.collect.android.utilities.FileUtils;
import tz.heath.collect.android.utilities.MediaUtils;
import tz.heath.collect.android.views.ODKView;
import tz.heath.collect.android.widgets.QuestionWidget;
...
public class FormEntryActivity extends Activity implements AnimationListener,
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (data instanceof FormLoaderTask) {
			...
			if (intent != null) {
				...
				if (getContentResolver().getType(uri).equals(InstanceProviderAPI.InstanceColumns.CONTENT_ITEM_TYPE)) {
...

					{
						...
						try {
							formCursor = getContentResolver().query(
									FormsProviderAPI.FormsColumns.CONTENT_URI, null, selection,
									selectionArgs, null);
							if (formCursor.getCount() == 1) {
								...
								// database to fix it.
								formCursor.moveToFirst();
								mFormPath = formCursor.getString(formCursor.getColumnIndex(FormsProviderAPI.FormsColumns.FORM_FILE_PATH));
				...
				} else if (getContentResolver().getType(uri).equals(FormsProviderAPI.FormsColumns.CONTENT_ITEM_TYPE)) {
					Cursor c = null;
					try {
				...
				.setSingleChoiceItems(languages, selected,
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
								...
								values.put(FormsProviderAPI.FormsColumns.LANGUAGE,
	...
	public void loadingComplete(FormLoaderTask task) {
		...
		if (languageTest != null) {
			...
			Cursor c = null;
			try {
				c = getContentResolver().query(FormsProviderAPI.FormsColumns.CONTENT_URI, null,
	...
	private boolean isInstanceComplete(boolean end) {
		...
		Cursor c = null;
		try {
			c = getContentResolver().query(InstanceProviderAPI.InstanceColumns.CONTENT_URI, null,
	...
	private void sendSavedBroadcast() {
		Intent i = new Intent();
		i.setAction("tz.health.collect.android.FormSaved");
